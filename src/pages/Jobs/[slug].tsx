...
const jobDetails = {
  "travel-consultant": {
    ...
    requirements: [
      ...
      "Knowledge of travel software (Amadeus, Sabre, etc.)",
      "Ability to plan detailed itineraries",
    ],
    tools: [
      "CRM Access",
      "Company Travel Database",
      "Remote Office Tools (Slack, Notion, Zoom)",
    ],
  },
  "customer-service": {
    ...
    tools: ["Zendesk", "Slack", "CRM Dashboard"],
  },
  admin: {
    ...
    requirements: [
      "Attention to detail",
      "Spreadsheet & procurement software skills",
      "Financial documentation experience",
    ],
    tools: ["ERP Access", "Google Workspace", "Slack"],
  },
  "content-creator": {
    ...
    requirements: [
      ...
      "Social media publishing knowledge",
    ],
    tools: ["Adobe Suite License", "Cloud Storage Access", "Brand Guidebook"],
  },
};
    ...
    try {
      ...
      if (resume) {
        ...
        const { error: uploadError } = await supabase.storage
          .from("job-resumes") // Make sure this bucket exists in Supabase
